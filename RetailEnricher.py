...
def main():
    ...
    orders_df = read_from_source(spark, input_base_dir, source_file_format, orders_data_folder, orders_custom_schema)
    ...
    write_to_sink(final_processed_df, sink_file_format, sink_output_mode, output_folder_name, output_base_dir)
